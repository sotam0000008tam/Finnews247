...
export default function AppsPage({
  ...
  const description = "Top crypto apps & wallets.";
...
export async function getServerSideProps({ params }) {
  ...
  const posts = readCat("best-crypto-apps");
  // newest → oldest trước khi phân trang
  posts.sort(
    (a, b) =>
  ...
  // Latest: coverage mỗi chuyên mục + bù pool toàn site, sort mới->cũ
  const cats = [
    "crypto-market",
    "altcoins",
    "crypto-exchanges",

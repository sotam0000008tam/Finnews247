...
export default function AltcoinsIndex({ posts = [], latest = [] }) {
  return (
    <>
      <NextSeo title="Altcoin Analysis | FinNews247" canonical="https://www.finnews247.com/altcoins" />
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="grid md:grid-cols-12 gap-8">
          <section className="md:col-span-9 grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {posts.map((it) => (
              <Link key={it.slug} href={buildUrl({ ...it, _cat: "altcoins" })} className="block rounded-lg border p-3 hover:bg-gray-50 dark:hover:bg-gray-800">

...
export default function AltcoinsPage({ items=[], latest=[], page=1, totalPages=1, signalsLatest=[] }){
  const title="Altcoin Analysis";
  const canonical=page>1?`https://www.finnews247.com/altcoins/page/${page}`:"https://www.finnews247.com/altcoins";
    ...
    <div className="grid md:grid-cols-12 gap-8">
      <section className="md:col-span-9">
        ...
        {totalPages>1&&(<div className="flex items-center justify-center gap-2 mt-6">
          {Array.from({length:totalPages}).map((_,i)=>{const p=i+1;const href=p===1?"/altcoins":`/altcoins/page/${p}`;const active=p===page;
...
export async function getServerSideProps({ params }){
  ...
  const postsRaw = readCat("altcoins")||[];

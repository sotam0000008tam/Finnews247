...
export default function SecIndex({items=[],latest=[],page=1,totalPages=1}){
  const title="SEC Coin"; const canonical="https://www.finnews247.com/sec-coin"+(page>1?`/page/${page}`:"");
  const description="SEC Coin articles.";
    ...
    <div className="grid md:grid-cols-12 gap-8">
      <section className="md:col-span-9">
        ...
        {totalPages>1&&(<div className="flex items-center justify-center gap-2 mt-6">
          {Array.from({length:totalPages}).map((_,i)=>{const p=i+1; const href=p===1?"/sec-coin":`/sec-coin/page/${p}`; const active=p===page;

...
const pickThumb = (p) =>
  p?.thumb || p?.ogImage || p?.image || firstImg(p?.content || "") || "/images/dummy/exchanges64.jpg";

const BASE = "/crypto-exchanges";

export default function ExchangesPaged({ items = [], page = 1, totalPages = 1 }) {
  return (

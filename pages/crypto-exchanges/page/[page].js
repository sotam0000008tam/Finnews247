...
export default function CryptoExchangesPage({
  ...
  const canonical =
    page > 1
      ? `https://www.finnews247.com/crypto-exchanges/page/${page}`
      : "https://www.finnews247.com/crypto-exchanges";
...
export async function getServerSideProps({ params }) {
  ...
  const posts = uniqBySignature([...ex, ...fi]).sort(
    (a, b) =>

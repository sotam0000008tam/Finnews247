...
/* Map URL cho sidebar/related theo _cat/category (consolidated) */
const buildUrl = (p) => {
...
export async function getServerSideProps({ params }) {
  ...
  // Tập bài cùng nhóm exchanges (gồm fidelity)
  const own = []
  ...
  /* Latest: coverage 6 trang chính (không có tax), rồi bù & sort mới→cũ */
  const groups = {

...
function Card({ item }){const href=hrefGuides(item.slug);const img=pickThumb(item);return(<Link href={href} className="group block rounded-xl  border bg-white dark:bg-gray-900 hover:shadow-md transition">

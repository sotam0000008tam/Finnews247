...
const SECTION_SOURCES = [
  ...
  },
  {
    ...
    files: [
      ...
      { name: "exchanges.json", canonical: true },       // thêm exchanges.json như canonical
  ...
  },
  {
    ...
    label: "Apps & Wallets",
    files: [
      { name: "bestapps.json", canonical: true }, // chính thức
      { name: "wallets.json", canonical: true },  // gộp wallets như canonical
    ],
